  ...
  <div class="container text-center col-md-12" style="margin-top: 10px; margin-bottom: 10px">
    <div class="card text-start">
      <div class="card-header d-flex ">
        ...
        <select class="drop" id="lnag" name="lang" v-model="formData.lang" placeholder="Lnguage"
      ...
      <div class="card-body">
        <textarea class="form-control" id="javaCode" rows="20" v-model="formData.code"
          @input="highlightCode"></textarea>
...
export default {
  ...
  methods: {
    ...
    run() {
      axios.post(BASE_URL + 'run', this.formData1, {
        headers: {
   ...
   this.approved=error.response.data.approved;
    ...
    Solve(problemId) {
      axios.post(BASE_URL + `assessment/solve/${problemId}`, this.formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        }
      })
