<template>
  ...
  import codeEdu from "./component/codeEdu.vue";
  import AddManuallyTest from "./component/AddManualyTest.vue";
  import NavBarA from "./component/NavBarA.vue";
  import Generate2 from "./component/Generate2.vue";
  import axios from "axios";
  import Alert from "./component/Alert.vue";
    import ADMIN_URL from "../../assets/config.js"
  ...
  export default {
    ...
    methods: {
      ...
      addTag() {
        ...
        console.log(token);
        axios
          .post("http://127.0.0.1:8000/api/adminstrator/problems/add-tag", this.formDataTag, {
      ...
      addProblem() {
        ...
        console.log(this.formData);
        axios
          .post("http://127.0.0.1:8000/api/adminstrator/problems/add-problem", this.formData, {
            headers: { Authorization: `Bearer ${token}` },
          })
          .then((response) => {
            // this.mesaage = response.data;
      ...
      getTags() {
        const token = localStorage.getItem("token");
        axios
          .get("http://127.0.0.1:8000/api/adminstrator/tags", {
            // .get(ADMIN_URL + "tags", {
            headers: { Authorization: `Bearer ${token}` },
          })
          .then((response) => {
