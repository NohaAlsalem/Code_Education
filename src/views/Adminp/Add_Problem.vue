  ...
  >
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-body" style="background: #e7dff9;">
          <div class="form-group">
            ...
            <input
              ...
              class="form-control"
              type="text"
              placeholder="Enter your tag" style="background: white;"
            />
          </div>
        </div>
        <div class="modal-footer" style="background: #e7dff9;">
          <button
            type="button"
...
<script>
import TopBar from "@/views/Adminp/component/TopBar.vue";
import codeEdu from "@/views/Adminp/component/codeEdu.vue";
import AddManualyTest from "@/views/Adminp/component/AddManualyTest.vue";
import NavBarA from "@/views/Adminp/component/NavBarA.vue";
import Generate2 from "@/views/Adminp/component/Generate2.vue";

// import show_sample from "@/views/Adminp/component/show_sample.vue";
import axios from "axios";
import Alert from "@/views/Adminp/component/Alert.vue";
...
export default {
  ...
  methods: {
    ...
    addTag() {
      ...
      console.log(token);
      // axios.post("http://127.0.0.1:8000/api/adminstrator/problems/add-tag", this.formDataTag, {
      axios.post(ADMIN_URL + "add-tag", this.formDataTag, {
    ...
    addProblem() {
      ...
      console.log(token);
      console.log(this.formData);
      // axios .post("http://127.0.0.1:8000/api/adminstrator/problems/add-problem", this.formData, {
        axios.post(ADMIN_URL + "problems/add-problem", this.formData, {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then((response) => {
          // this.mesaage = response.data;
    ...
    this.alertMessage = "An unknown error occurred.";
          ...
          // this.alertMessage = "Error adding problem: " + error.response.data.message;
        });
    },

    getTags() {
      const token = localStorage.getItem("token");
      // axios.get("http://127.0.0.1:8000/api/adminstrator/tags", {

        axios.get(ADMIN_URL + "tags", {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then((response) => {
